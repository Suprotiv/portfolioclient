    ...
    <div className="relative top-0 left-0 w-full h-screen text-white overflow-hidden">
      <div className="w-full h-full relative">
        ...
        <div className="z-20 absolute top-[28vh] md:top-[32vh] w-[90%] md:w-[80%] lg:w-[60%] xl:w-[50%] mx-[5%] md:mx-[10%] lg:mx-[20%]  animate-fadeInSlow">
          <p className="text-gray-300 text-sm md:text-md my-3 lg:text-lg">
            Professional video editor and visual artist
          </p>
          <h1 className="text-white text-4xl lg:text-5xl my-2 font-bold ">
            Rounak Chowdhury's
          </h1>

          <h1 className="text-white text-4xl lg:text-5xl mt-2 mb-4 font-bold ">
            Portfolio
          </h1>
          <button
            onClick={() => navigate("/about")}
            className="top-1 relative group mb-8 text-white  py-4 px-6 border-none bg-transparent tracking-wide transition-all duration-500"
          >
            SEE MORE ABOUT ME
