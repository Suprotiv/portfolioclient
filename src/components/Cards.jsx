...
const Card = ({ image , name }) => {
  ...
  return (
    <motion.div
      className="relative overflow-hidden h-[140px] min-w-[140px] md:h-[170px] md:min-w-[170px] bg-slate-400 rounded-xl flex justify-center items-center hover:cursor-pointer"
      key={image}
